...
public class Conexao_SQLite {
    ...
    private static final String SQLITE_DATABASE_URL = "jdbc:sqlite:src\\main\\resources\\ELETRO_TECH_DB";

    private static Connection conn = null;

    public static Connection getConexao() throws SQLException { //Faz a conexao com o banco
        if (conn == null) {
            try {
